...
class TimeBiLSTM:
    def __init__(self, Wx1, Wh1, b1,
        ...
        self.forward_lstm = ly.TimeLSTM(Wx1, Wh1, b1, stateful)
        self.backward_lstm = ly.TimeLSTM(Wx2, Wh2, b2, stateful)
...
class GRU:
    ...
    def forward(self, x, h_prev):
        ...
        z = functions.sigmoid(np.dot(x, Wxz) + np.dot(h_prev, Whz) + bz)
        r = functions.sigmoid(np.dot(x, Wxr) + np.dot(h_prev, Whr) + br)
